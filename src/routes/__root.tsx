...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CareBox — Family prescription records" },
      {
        name: "description",
        content:
          "CareBox keeps a private, photographed history of prescriptions for you and your family.",
      },
      { property: "og:title", content: "CareBox — Family prescription records" },
      {
